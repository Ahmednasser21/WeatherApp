...
class FakeRemoteDataSource(private val fakeWeatherApiService: FakeWeatherApiService) {
    ...
    suspend fun getForecastData(lat: Double, lon: Double, units: String? = null, lang: String? = null,): WeatherForecastResponse {
        return fakeWeatherApiService.getForecastData(lat, lon, units, lang,"fake-api-key")
    }

    suspend fun getCurrentData(lat: Double, lon: Double, units: String? = null, lang: String? = null): WeatherCurrentResponse {
